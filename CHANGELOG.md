...
### Changed
- README: added PyPI, Python version, MIT license, and CI status badges
- README: added uv install instructions (uv tool install, uv pip install, uvx)
- README: expanded License section, added Requirements section
- pyproject.toml: added [dev] optional dependency (pytest>=7)
